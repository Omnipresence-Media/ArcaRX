      ...
      <Card className="surface-elevated">
        <CardContent className="p-4 md:p-5">
          <div className="flex items-end justify-between">
            ...
            <Button size="sm" variant="outline" className="h-8 text-xs">+ Log weight</Button>
          </div>
          <div className="mt-3"><Chart data={weightLog} /></div>
        </CardContent>
      </Card>
        ...
        <CardContent className="p-4 md:p-5 space-y-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm">Compare {photoSessions[0].label} vs {photoSessions[2].label}</p>
            </div>
            <Button size="sm" variant="outline" className="h-8 text-xs"><Camera className="mr-1 h-3.5 w-3.5" />Upload</Button>
          </div>
          <div className="relative aspect-[4/3] w-full overflow-hidden rounded-md border">
            <div className={`absolute inset-0 bg-gradient-to-br ${photoSessions[2].color}`}>
              <div className="flex h-full items-center justify-center text-xs uppercase tracking-[0.2em] text-white/60">{photoSessions[2].label} · {photoSessions[2].date}</div>
            </div>
            <div className={`absolute inset-y-0 left-0 overflow-hidden bg-gradient-to-br ${photoSessions[0].color}`} style={{ width: `${comparing}%` }}>
              <div className="flex h-full items-center justify-center text-xs uppercase tracking-[0.2em] text-white/60">{photoSessions[0].label} · {photoSessions[0].date}</div>
            </div>
      ...
      <Card className="surface-elevated">
        <CardContent className="p-4 md:p-5">
          <div className="flex items-center justify-between">
            ...
            <Button size="sm" className="h-8 gradient-brand text-xs text-white">+ New check-in</Button>
          </div>
